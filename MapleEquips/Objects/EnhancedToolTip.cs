...
namespace MapleEquips.Objects {
    ...
    /// <summary>
    /// EnhancedToolTip to create tooltips with Image.
    /// </summary>
    internal class EnhancedToolTip : ToolTip {
        #region Constants
        ...
        //private Brush myBackColorBrush = new SolidBrush(Color.FromArgb(50, Color.Transparent));
        private Brush myBackColorBrush = new SolidBrush(Color.FromArgb(50, 128, 128, 128));
        ...
        /// <summary>
        /// Constructor to create instance of EnhancedToolTip class that can display Thumbnails/Images in it.
        /// </summary>
        public EnhancedToolTip() {
            try {
                ...
                this.Popup += new PopupEventHandler(EnhancedToolTip_Popup);
                this.Draw += new DrawToolTipEventHandler(EnhancedToolTip_Draw);
            } catch (Exception ex) {
                string logMessage = "Exception in EnhancedToolTip.EnhancedToolTip () " + ex.ToString();
        ...
        protected override void Dispose(bool disposing) {
            try {
                ...
                string logMessage = "Exception in EnhancedToolTip.Dispose (bool) " + ex.ToString();
                Trace.TraceError(logMessage);
                throw;
            }
        }
        ...
        /// <summary>
        /// EnhancedToolTip_Draw raised when tooltip is drawn.
        /// </summary>
        /// <param name="sender">sender</param>
        /// <param name="e">e</param>
        void EnhancedToolTip_Draw(object sender, DrawToolTipEventArgs e) {
            try {
                ...
                string logMessage = "Exception in EnhancedToolTip.BlindHeaderToolTip_Draw (object, DrawToolTipEventArgs) " + ex.ToString();
                Trace.TraceError(logMessage);
                throw;
            }
        }
        ...
        /// <summary>
        /// EnhancedToolTip_Popup raised when tooltip pops up.
        /// </summary>
        /// <param name="sender">sender</param>
        /// <param name="e">e</param>
        void EnhancedToolTip_Popup(object sender, PopupEventArgs e) {
            try {
                if (OwnerDraw) {
                    if (!myAutoSize) {
                ...
                string logMessage = "Exception in EnhancedToolTip.EnhancedToolTip_Popup (object, PopupEventArgs) " + ex.ToString();
                Trace.TraceError(logMessage);
                throw;
            }
        }
